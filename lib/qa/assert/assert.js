...
qa.assert.success = function(scenario, comment) {
  ...
  function assert(input, complete, cancel) {
    ...
    function localComplete(data) {
      folder.passResult(qa.result.assertion(true), comment);
      complete(data);
    }
    ...
    function localCancel(error, opt_code) {
      folder.passResult(qa.result.assertion(false), [comment, error]);
  ...
  function assert(input, complete, cancel) {
    ...
    function localCancel(error, opt_code) {
      if (!done) {
        ...
        folder.passResult(qa.result.assertion(true), [comment, error]);
        complete(input);
      }
    }
     ...
     */
    function localComplete(data) {
      folder.passResult(qa.result.assertion(false), comment);
      cancel(comment);
    }
...
qa.assert.equals = function(value, comment) {
  ...
  function assert(input, complete, cancel) {
    ...
    this.passResult(qa.result.assertion(assertion), comment);
