...
qa.state.assert.equals = function(path, comment) {
  var base = new qa.state.Path(path);
  ...
  function assert(input, complete, cancel) {
    var assertion = input === base.get(this);
...
qa.state.assert.equalsValues = function(base, target, comment) {
  var basePath = new qa.state.Path(base);
  var targetPath = new qa.state.Path(target);
   ...
   */
  function assert(input, complete, cancel) {
    var assertion = targetPath.get(this) === basePath.get(this);
