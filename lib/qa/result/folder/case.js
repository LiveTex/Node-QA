 ...
 * @inheritDoc
 */
qa.result.folder.Case.prototype.passState = function(tags) {
  this.__parent.passResult(this.__result, [this.__name].concat(tags));
};
 ...
 * @inheritDoc
 */
qa.result.folder.Case.prototype.passResult = function(result, tags) {
