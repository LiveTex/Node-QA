 ...
 */
qa.result.folder.IFolder.prototype.passState = function(tags) {};


/**
 * Применение результата теста накопителем.
 *
 * Применению результата сопуствует упорядоченный набор меток результата,
 * необходимый для соотствующей обработчки накопителем.
 *
 * @param {!qa.result.IResult} result Результат теста.
 * @param {!qa.result.Tags} tags Метки реультата.
 */
qa.result.folder.IFolder.prototype.passResult = function(result, tags) {};
