 ...
 */
qa.business.ChatServerConnection = function(host, opt_port) {
 ...
 * @inheritDoc
 */
qa.business.ChatServerConnection.prototype.setCallback =
 ...
 */
qa.business.ChatServerConnection.prototype.__handleData = function(data) {
  var response = qa.business.ChatServerResponse.decode(data);
  if (response !== null) {
