...
/**
 * @param {string} poll Polling identifier.
 */
 ...
 * @inheritDoc
 */
qa.business.comm.PollingServerConnection.prototype.setCallback =
    function(event, callback) {
  return new ds.queue.QueueItem(null);
};
 ...
 * @inheritDoc
 */
qa.business.comm.PollingServerConnection.prototype.removeCallback =
