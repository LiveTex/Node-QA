 ...
 */
qa.db.assert.equals = function(basePath, comment) {
 ...
 * @return {!async.Step} Тест.
 */
qa.db.assert.equalsValues = function(basePath, targetPath, comment) {
  var base = new qa.db.Path(basePath);
 ...
 * @return {!async.Step} Тест.
 */
qa.db.assert.equalsTo = function(basePath, value, comment) {
  var base = new qa.db.Path(basePath);
 ...
 * @return {!async.Step} Тест.
 */
qa.db.assert.exists = function(path, comment) {
 ...
 * @return {!async.Step} Тест.
 */
qa.db.assert.type = function(path, type, comment) {
  var evaluator = new qa.db.Path(path);
