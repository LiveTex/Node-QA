 ...
 * @param {qa.business.app.Application=} opt_app Application.
 */
qa.ApplicationTestCase = function(opt_name, opt_app) {
  qa.TestCase.call(this, opt_name);

  /**
   * @type {qa.business.app.Application}
   */
  this.__application = (opt_app instanceof
      qa.business.app.Application) ? opt_app : new qa.business.app.Application;

  /**
   * @type {Array.<!a.business.entity.Client>}
   */
  this.__clients = [];
...
qa.ApplicationTestCase.prototype.buildStep = function() {
  ...
  return function(data, complete, cancel) {
    async.sequence(
        ...
        call(self.__application, data, complete, cancel);
  }
};
