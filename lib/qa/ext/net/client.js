 ...
 * @param {!Object=} opt_options Параметры соединения.
 * @return {!qa.ext.net.socket.Wrapper} Созданный сокет.
 */
qa.ext.net.Client.prototype.createSocket = function(socket, opt_options) {
  return new qa.ext.net.socket.Wrapper(socket, opt_options);
};
