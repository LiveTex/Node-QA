 ...
 */
qa.ext.net.socket.create = function(name, socket, optionsPath,
                                    opt_netClientName) {
  ...
  function create(input, complete, cancel) {
    ...
    if (client instanceof qa.ext.net.Client) {
      ...
      this.registerClient(name, client.createSocket(socket, options));
 ...
 * @return {!async.Step} Socket creation step.
 */
qa.ext.net.socket.createEcho = function(name, optionsPath,
                                        opt_netClientName) {
  return qa.ext.net.socket.create(name, new qa.ext.net.socket.EchoSocket(),
      optionsPath, opt_netClientName);
};
 ...
 * @return {!async.Step} Socket creation step.
 */
qa.ext.net.socket.createWs = function(name, optionsPath,
                                      opt_netClientName) {
  return qa.ext.net.socket.create(name, new qa.ext.net.socket.WebSocket(),
      optionsPath, opt_netClientName);
};
