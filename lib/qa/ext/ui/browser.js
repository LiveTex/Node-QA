 ...
 * @param {qa.ext.ui.Version=} opt_version Browser version
 * @return {!async.Step}
 */
qa.ext.ui.Browser.prototype.createSession =
    function(opt_browserName, opt_platform, opt_version) {
  var self = this;
  ...
  function createSession(input, complete, cancel) {
    ...
    if (self.__sessionId !== null) {
      self.__httpClient.request(seleniumSettings, util.encodeJson({
        'desiredCapabilities': {
          'browserName': opt_browserName || qa.ext.ui.BrowserName.FIREFOX,
          'platform': opt_platform || qa.ext.ui.Platform.ANY,
          'version': opt_version || qa.ext.ui.Version.ANY,
 ...
 * @return {!async.Step}
 */
qa.ext.ui.Browser.prototype.frame = function(name) {
  return this.request('/frame/', 'POST', { name: name });
};
