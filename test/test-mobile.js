...
var member = new qa.business.entity.Member('testetrem@gmail.com', '123123',
    '77BD902C-9FBE-5EAB-944A-A5DC8421C846');
...
var stickyVisitorScenario = async.sequence([
  ...
  qa.business.utils.async.barrier('prepare for chat'),
  qa.business.app.visitor.openChat,
  qa.business.app.visitor.assertHasChatWith(member),
  qa.business.utils.async.barrier('visitor open chat'),
  qa.business.app.visitor.ioDisconnect,
  qa.business.utils.async.barrier('ALL is OK!')
]);
...
var memberScenario = async.sequence([
  ...
  qa.business.app.member.offline,
  qa.business.utils.async.barrier('ALL is OK!')
]);
...
memberScenario.call(memberSession, member,
    function(data) {process.exit(0);}, console.error);
